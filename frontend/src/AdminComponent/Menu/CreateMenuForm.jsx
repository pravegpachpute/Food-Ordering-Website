...
import { getIngredintsOfResturant } from "../../component/State/Ingredients/Action";
...
const CreateMenuForm = () => {
  ...
  const handleRemoveImage = (index) => {
   ...
   useEffect(() => {
      dispatch(getIngredintsOfResturant({jwt, id: resturant.usersResturant.id}));
    }, []);
            ...
            <Grid item xs={12} lg={6}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  name="category"
                >
                 {resturant.categories?.map((item)=> <MenuItem value={item}>{item.name}</MenuItem>) }
