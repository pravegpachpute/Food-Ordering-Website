...
const RestuarantDetails = () => {
  ...
  //create category
  useEffect(() => {
    dispatch(getResturantById({ jwt, resturantId: id }));
    dispatch(getResturantsCategory({ jwt, resturantId: id }));
  }, []);
  ...
  return (
    <div className="px-5 lg:px-20 ">
      {/* Resturant page  */}
      <section>
        <h3 className="text-gray-500 py-2 mt-10">Home/Resturant Details</h3>
        <div>
          {/* Grid */}
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <img
                ...
                src={resturant.resturant?.images[0]}
