...
const menuItemReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionType.GET_MENU_ITEMS_BY_RESTURANT_ID_REQUEST:
    ...
    case actionType.GET_MENU_ITEMS_BY_RESTURANT_ID_SUCCESS:
      return {
        ...state,
        loading: false,
    ...
    //  replace existing menu items to new
    case actionType.UPDATE_MENU_ITEMS_AVAILABILITY__SUCCESS:
    ...
    case actionType.GET_MENU_ITEMS_BY_RESTURANT_ID_FAILURE:
    case actionType.DELETE_MENU_ITEM_FAILURE:
    case actionType.SEARCH_MENU_ITEM_FAILURE:
    case actionType.UPDATE_MENU_ITEMS_AVAILABILITY__FAILURE:
      return {
        ...state,
        loading: false,
