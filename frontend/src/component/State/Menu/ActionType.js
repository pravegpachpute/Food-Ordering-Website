...
export const GET_MENU_ITEMS_BY_RESTURANT_ID_REQUEST = "GET_MENU_ITEMS_BY_RESTURANT_ID_REQUEST";
export const GET_MENU_ITEMS_BY_RESTURANT_ID_SUCCESS = "GET_MENU_ITEMS_BY_RESTURANT_ID_SUCCESS";
export const GET_MENU_ITEMS_BY_RESTURANT_ID_FAILURE = "GET_MENU_ITEMS_BY_RESTURANT_ID_FAILURE";
...
export const UPDATE_MENU_ITEMS_AVAILABILITY__SUCCESS = "UPDATE_MENU_ITEMS_AVAILABILITY__SUCCESS";
export const UPDATE_MENU_ITEMS_AVAILABILITY__FAILURE = "UPDATE_MENU_ITEMS_AVAILABILITY__FAILURE";
