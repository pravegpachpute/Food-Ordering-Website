...
import com.floobyte.franchise.request.LoginRequest;
import com.floobyte.franchise.response.AuthResponse;
import com.floobyte.franchise.service.impl.CustomerUserDetailsService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user)
        ...
        if(isEmailExist!= null){
            throw new Exception("Email is already use another account");
        }
